...
class DonatePage extends FormPage
{
	...
	public function getCMSFields()
	{
		...
		$fields->addFieldToTab("Root.Main", HTMLEditorField::create("RedirectText", "Text Explaining PayPal Redirect"),"Metadata");
		if(permission::check('ADMIN')){
			$fields->addFieldToTab("Root.PayPalSettings", TextField::create("PayPalAccount", "PayPal Account (email address)"));
		}
		return $fields;
	}	
}	
